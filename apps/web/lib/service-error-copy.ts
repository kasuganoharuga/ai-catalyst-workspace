...
const FOUNDER_MESSAGE_BY_CODE: Partial<Record<ServiceErrorCode, string>> = {
  ...
  MODULE_NOT_READY_FOR_CONFIRMATION:
    "There's nothing to confirm here yet. This page updates once Claude saves your work and it passes its checks.",

  ATTEMPT_PENDING_REVIEW:
    "Your work is being checked. Refresh in a moment to see the result.",
  ATTEMPT_NOT_EDITABLE:
    "This attempt is closed, so nothing new can be saved to it. Start another pass to keep working.",
  ATTEMPT_NOT_SUBMITTABLE:
    "This attempt can't be submitted yet. Finish the conversation in Claude first.",
  ATTEMPT_RETRY_SOURCE_INVALID:
    "There's no attempt available to retry. Confirm this module, or ask your programme lead.",
  ...
  VALIDATOR_NOT_CONFIGURED:
    "This module's checks aren't ready yet. Try again shortly, and tell your programme lead if it persists.",
  ...
  INTERNAL_INVARIANT_ERROR:
    "Something went wrong on our side. Tell your programme lead if it keeps happening.",
};
